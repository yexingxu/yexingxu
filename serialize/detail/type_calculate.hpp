 ...
 * @LastEditTime: 2024-01-05 08:11:44
 */
...
template <typename Arg, typename... ParentArgs>
struct check_if_has_container;

template <typename Arg, typename... ParentArgs, std::size_t... I>
constexpr bool check_if_has_container_helper(std::index_sequence<I...>);

template <typename A, typename... ParentArgs>
struct check_if_has_container {
  template <typename Arg = A,
  ...
  template <typename Arg = A, std::enable_if_t<is_trivial_view_v<Arg>, int> = 0>
  constexpr inline bool operator()() {
